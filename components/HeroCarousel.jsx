...
import WorkSpace3 from "../assets/images/workspace/site-img (2).jpg";
import WorkSpace4 from "../assets/images/workspace/site-img (6).jpg";
import WorkSpace5 from "../assets/images/workspace/site-img (8).jpg";
