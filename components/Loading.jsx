...
const Loading = () => {
  return (
    <div className="w-full h-screen bg-white scale-y-100 transition-all duration-500 absolute top-0 left-0 flex items-center justify-center opacity-100 z-[100] black-gradient ">
      <div className="loader w-32  md:w-56">
        {/* <svg
