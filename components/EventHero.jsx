          ...
          <div className="hero__data grid gap-8 justify-self-center text-center xs:max-w-sm sm:max-w-lg lg:max-w-full lg:text-left">
            <div>
              <h1 className="hero__title section-title xl:text-[50px] font-black capitalize">
                Experience the Magic of Office Box Events
                <span className=" text-primary">.</span>
              </h1>
              <p className="hero__text section-text text-lg pb-0 xl:max-w-md">
                Welcome to the Office Box Events page, your gateway to a world
                of knowledge, creativity, and connection. Our carefully curated
                events are designed to inspire, educate, and entertain, catering
                to a diverse audience of professionals, artists, and innovators.
              </p>
            </div>
          </div>
